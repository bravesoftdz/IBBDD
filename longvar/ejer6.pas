...
var
   ...
   archi: Text;
   opcion:char;
   dni, fecha, i, variablelong: Longword;
   P:tPersona;
   info_nom, info_ape, nombre, nom, ape, nomlib, variablestring: String;
...
begin
     ...
     begin
          case opcion of
               'h':   begin
                           variablestring:= 'albertino';
                           variablelong:= 2222;
                           for i:= 1 to 200 do
                               CargarHecho(A, variablestring, variablelong);
                           Clrscr;
                      end;
               '1':     begin
